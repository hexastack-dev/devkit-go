...
func TestNil(t *testing.T) {
	...
	if v1.Value() != 0 {
		t.Errorf("should be equals 0: %d", v1.Value())
	}
	if v1.String() != "nil" {
	...
	if v2.Value() != "" {
		t.Errorf("Value() should be empty string: %s", v2.Value())
	}
	if v2.String() != "nil" {
	...
	if v3.Value() != (person{}) {
		t.Errorf("Value() should be empty struct: %+v", v3.Value())
	}
	if v3.String() != "nil" {
	...
	if v4.Value() != nil {
		t.Errorf("Value() should be nil: %+v", v4.Value())
	}
	if v4.String() != "nil" {
...
func TestOf(t *testing.T) {
	...
	if v1.Value() != 32 {
		t.Errorf("Value() should be equals 32: %d", v1.Value())
	}
	if v1.String() != "32" {
	...
	if v2.Value() != "hello" {
		t.Errorf("Value() should be equals hello: %s", v2.Value())
	}
	if v2.String() != "hello" {
	...
	if v3.Value() != (person{}) {
		t.Errorf("Value() should be equals empty struct: %+v", v3.Value())
	}
	if v3.String() == "{}" {
...
func TestOptional_UnmarshalJSON(t *testing.T) {
	...
	if p.Preference2.IsNil() {
		...
		pref := p.Preference2.Value()
		if pref.Push.IsNil() {
			t.Errorf("Preference2.Push should not be nil")
		} else if !pref.Push.Value() {
		...
		} else if pref.TransactionLimit.Value() == 0 {
